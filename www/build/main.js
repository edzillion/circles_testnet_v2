...
let HomePage = class HomePage {
    constructor(navCtrl, navParams, notificationsService, camera, db, ds, toastCtrl, userService, newsService, validatorService) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    goToUserDetail(user) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_10__user_detail_user_detail__["a" /* UserDetailPage */], user);
    }
    goToValidatorDetail(validator) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_11__validator_detail_validator_detail__["a" /* ValidatorDetailPage */], validator);
    }
    selectNetwork() {
        this.selectedView = 'network';
    }
    ...
    ionViewDidLoad() {
        this.userSub$ = this.userService.user$.subscribe(user => {
            ...
            if (this.user.validators) {
                this.validatorService.validators$.subscribe(valis => {
                    for (let vKey of this.user.validators) {
                        let v = valis[vKey];
